# O(nm * min(n,m)) | O(nm * min(n,m)) space
# def longestCommonSubsequnce(str1, str2):
...
if __name__ == '__main__':
    print("LCS for str1: %(str1)s and str2: %(str2)s is %(method)s" %
          {"str1": "zxvvyzw", "str2": "xkykzpw", "method": longestCommonSubsequnce("zxvvyzw", "xkykzpw")})
