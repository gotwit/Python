import Prog_NoOfWaysToMakeChange as program
import unittest
...
class TestProgram(unittest.TestCase):
    ...
    def test_case_5(self):
        self.assertEqual(
            program.numberOfWaysToMakeChange(4, [1, 5, 10, 25]), 1)

    def test_case_6(self):
        self.assertEqual(
            program.numberOfWaysToMakeChange(5, [1, 5, 10, 25]), 2)

    def test_case_7(self):
        self.assertEqual(
            program.numberOfWaysToMakeChange(10, [1, 5, 10, 25]), 4)

    def test_case_8(self):
        self.assertEqual(program.numberOfWaysToMakeChange(
            25, [1, 5, 10, 25]), 13)
