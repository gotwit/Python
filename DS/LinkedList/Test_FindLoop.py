import Prog_FindLoop as program
import unittest
...
class TestProgram(unittest.TestCase):
    ...
    def test_case_1(self):
        ...
        # self.assertEqual(program.LinkedList.findLoop(self,test1), test1.getNthNode(1))
        self.assertEqual(program.LinkedList.findLoop(
            self, test1), test1.getNthNode(1))
